...
def footer() -> str:
  ...
  <a class="footer-note" href="https://note.com/punchline_tokyo" target="_blank" rel="noopener" aria-label="PUNCHLINE TOKYOのnoteへ"><img src="/images/noteバナー.png" alt="PUNCHLINE TOKYO note"></a>
  <div>株式会社PUNCHLINE TOKYO<br>EPARKフィナンシャルパートナーズ正規代理店<br>© 2026 PUNCHLINE TOKYO</div>
</div></footer>"""
