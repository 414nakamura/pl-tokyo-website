...
<section class="section alt"><div class="container"><div class="eyebrow">Official References</div><h2 class="section-title">公的情報も確認しながら、慎重に判断しましょう。</h2><p class="lead">キャッシュレス決済は店舗の売上・資金繰り・顧客対応に関わるため、サービス資料だけでなく公的機関の情報も参考にすることをおすすめします。</p><div class="grid"><a class="card" href="https://www.meti.go.jp/policy/mono_info_service/cashless/" target="_blank" rel="noopener noreferrer" style="text-decoration:none"><h3>経済産業省：キャッシュレス政策</h3><p>キャッシュレス推進に関する政策情報を確認できます。</p></a><a class="card" href="https://www.fsa.go.jp/" target="_blank" rel="noopener noreferrer" style="text-decoration:none"><h3>金融庁</h3><p>金融サービスや利用者保護に関する公的情報を確認できます。</p></a><a class="card" href="https://www.caa.go.jp/" target="_blank" rel="noopener noreferrer" style="text-decoration:none"><h3>消費者庁</h3><p>消費者保護や取引に関する公的情報を確認できます。</p></a></div></div></section>
...
<section class="section alt"><div class="container"><div class="eyebrow">Official References</div><h2 class="section-title">公的情報でキャッシュレスの制度背景も確認できます。</h2><p class="lead">端末や料率の比較だけでなく、キャッシュレス決済の社会的な位置づけや金融サービスに関する公的情報も確認しておくと安心です。</p><div class="grid"><a class="card" href="https://www.meti.go.jp/policy/mono_info_service/cashless/" target="_blank" rel="noopener noreferrer" style="text-decoration:none"><h3>経済産業省：キャッシュレス政策</h3><p>キャッシュレス推進に関する政策情報を確認できます。</p></a><a class="card" href="https://www.fsa.go.jp/" target="_blank" rel="noopener noreferrer" style="text-decoration:none"><h3>金融庁</h3><p>金融サービスや利用者保護に関する公的情報を確認できます。</p></a><a class="card" href="https://www.caa.go.jp/" target="_blank" rel="noopener noreferrer" style="text-decoration:none"><h3>消費者庁</h3><p>消費者保護や取引に関する公的情報を確認できます。</p></a></div></div></section>
